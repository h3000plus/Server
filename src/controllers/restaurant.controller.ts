...
export const getFilteredRestaurantsController = async (req: Request, res: Response) => {
    try {
...
export const searchAllDeliveryRestaurantsController = async (req: Request, res: Response) => {
    try {
        const searchTerm = req.query.searchTerm as string;
...
export const getAllRestaurantsByCuisineController = async (req: Request, res: Response): Promise<void> => {
    try {
